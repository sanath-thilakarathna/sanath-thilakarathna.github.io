...
1. **Normal Stress (\\( \\sigma \\))** – This is when the force is acting straight on the surface, either pulling or pushing.
   ...
   - _Tensile stress_ pulls the material apart, like when you stretch a rubber band.
   - _Compressive stress_ pushes the material together, like when you press down on a sponge.
