...
Every pure tone you hear (like a tuning fork or a flute note) is basically a sine wave of a specific frequency. These are the fundamental frequencies. But most real-world sounds—like speech, music, or noise—are _combinations_ of many sine waves of different frequencies and amplitudes.
